...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"><span style="font-size: 130%; ">UsersCRUD</span></h1>
            ...
            <div class="table-responsive">
                <table class="table">
                    <div class="form-group">
                        <label><h4><span style="color:darkblue; ">Id: </span></h4></label>
                        <label><h5>${user.id}</h5></label>
                    </div>
                    <div class="form-group">
                        <label><h4><span style="color:darkblue; ">Nazwa: </span></h4></label>
                        <label><h5>${user.userName}</h5></label>
                    </div>
                    <div class="form-group">
                        <label><h4><span style="color:darkblue; ">Email:</span></h4></label>
                        <label><h5>${user.email}</h5></label>
                    </div>
                    <div>
                        <a href='<c:url value="/user/edit?id=${user.id}"/>'><h5><span
                                style="font-size: 110%; ">Edytuj</span></h5></a>
                        <a href='<c:url value="/user/delete?id=${user.id}"/>'><h5><span
                                style="font-size: 110%; ">Usuń</span></h5></a>
                    </div>
                </table>
            </div>
        </div>
